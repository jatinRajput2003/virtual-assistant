...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Jatin"<<endl;
        string phrase = "Good Morning Master Jatin";
        ...
        cout<< "Good Afternoon Master Jatin"<<endl;
        string phrase = "Good Afternoon Master Jatin";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening  Jatin"<<endl;
        string phrase = "Good Evening  Jatin";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER JATIN|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE JATIN";
        string command = "espeak  \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="Jatin")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Jatin...."<<endl<<endl;

                string phrase = "How can i help you Jatin";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"I'm a personal assistant created by Jatin !!!"<<endl;
                    string phrase = "I'm a personal assistant created by  Jatin !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                //type mpegvideo alias mp3

                else if(command=="open mail")
                {
                    cout<<"opening mail"<<endl;
                    string phrase = "opening mail";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                ...
                else if(command=="open photo")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,_T("open"),_T("C:\\Users\\rajpu\\OneDrive\\Pictures\\new.jfif"),NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open oops book")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,_T("open"),_T(""),NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,_T("open"),_T("C:\\Users\\rajpu\\OneDrive\\Pictures\\vi.mp4"),NULL, NULL, SW_NORMAL);
                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Master Jatin, see you soon!"<<endl;
                    string phrase = "Good Bye Master Jatin, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
